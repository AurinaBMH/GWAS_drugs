...
[geneWeightsGWAS_ALL_train, drugScores_train, similarityTypes, PPImeasures_names] = give_GWASandDRUG_scores(disorderTrain, whatMeasures);
% select other disorder scores to compare to
[geneWeightsGWAS_ALL_test, drugScores_test] = give_GWASandDRUG_scores(disorderTest, whatMeasures);
...
mdl = fitlm(geneWeightsGWAS_ALL_train,drugScores_train);
