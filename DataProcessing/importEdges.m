function eQTLedges = importEdges(fileName)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   EQTLEDGES = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   EQTLEDGES = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   eQTLedges = importfile('eQTL_edges.csv', 2, 307532);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/06/14 12:11:18

if nargin < 1
    fileName = 'eQTL_edges.csv';
end
...
formatSpec = '%s%f%s%s%f%f%f%f%f%f%[^\n\r]';
