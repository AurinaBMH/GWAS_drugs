function eQTLidentifier = importIdentifier_eQTL()
%IMPORTFILE Import numeric data from a text file as a matrix.
%   EQTLIDENTIFIER = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   EQTLIDENTIFIER = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   eQTLidentifier = importfile('eQTL_identifier.csv', 2, 64871);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/06/14 12:17:20

fileName = 'eQTL_identifier.csv';
